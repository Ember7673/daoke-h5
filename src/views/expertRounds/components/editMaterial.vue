    ...
    <div class="materialContent">
      ...
      >
        ...
        <el-form-item label="专家查房/坐诊时进行的照片">
          ...
          <input type="file" accept="image/*" @change.self="onUploadFile('cha_fang_pic')">
        </el-form-item>
        <el-form-item label="专家与患者的沟通、与其他医生的交流照片">
          ...
          <input type="file" accept="image/*" @change.self="onUploadFile('jiao_liu_pic')">
        </el-form-item>
        <el-form-item label="专家总结交流照片">
          ...
          <input type="file" accept="image/*" @change.self="onUploadFile('zong_jie_pic')">
        </el-form-item>
        ...
        <el-form-item label="主席/主持人照片">
          ...
          <input type="file" accept="image/*" @change.self="onUploadFile('zhu_chi_ren_pic')">
        </el-form-item>
        <el-form-item
        ...
        :key="item.key">
          ...
          <input type="file" accept="image/*" @change.self="onUploadFile('jiang_zhe_pic', index)">
        </el-form-item>
        <div class="btnGroup">
        ...
        <el-form-item label="培训班全景照片（体现全部参会人员）">
          ...
          <input type="file" accept="image/*" @change.self="onUploadFile('pei_xun_ban_pic')">
        </el-form-item>
        <el-form-item label="会场布景照片（体现会议摆放展架、桌卡等）">
          ...
          <input type="file" accept="image/*" @change.self="onUploadFile('bu_zhi_pic')">
        </el-form-item>
        ...
        <el-form-item label="签到表">
          ...
          <input type="file" accept="image/*" @change.self="onUploadFile('qian_dao_biao')">
        </el-form-item>
